...
var UsersController = function () {
    ...
    var UsersController = _classThis = /** @class */ (function () {
        ...
        UsersController_1.prototype.createUser = function (createUserDto) {
            return this.userService.create(createUserDto);
        };
        UsersController_1.prototype.update = function (id, userUpdate) {
            return __assign({ id: id }, userUpdate);
        };
